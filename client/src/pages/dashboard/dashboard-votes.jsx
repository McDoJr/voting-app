    ...
    return (
        <div className="p-8 flex flex-col w-[50%] select-none">
            ...
            <div className="flex mb-6">
                <div className="w-32 h-16 flex justify-center items-end flex-wrap mr-2">
                    <h3 className="font-[500] text-center">{candidates[0].firstname} {candidates[0].lastname}</h3>
                </div>
            ...
            <div className="flex">
                <div className="w-32 h-16 flex justify-center items-end flex-wrap mr-2">
                    <h3 className="font-[500] text-center">{candidates[1].firstname} {candidates[1].lastname}</h3>
                </div>
                <div className="flex w-full">
